...
struct HfTaskFlowCharmHadrons {
                       ...
                       T1 const& candidates)
  {
    ...
    for (const auto& candidate : candidates) {
      ...
      float cosNPhi = cos(harmonic * phiCand);
      float sinNPhi = sin(harmonic * phiCand);
      float scalprodCand = cosNPhi * xQVec + sinNPhi * yQVec;
      float cosDeltaPhi = cos(harmonic * (phiCand - evtPl));
  ...
  void processResolution(CollsWithQvecs::iterator const& collision)
  {
    ...
    if (saveEpResoHisto) {
      ...
      registry.fill(HIST("epReso/hEpResoFT0cFT0a"), centrality, cos(harmonic * getDeltaPsiInRange(epFT0c, epFT0a)));
      registry.fill(HIST("epReso/hEpResoFT0cFT0m"), centrality, cos(harmonic * getDeltaPsiInRange(epFT0c, epFT0m)));
      registry.fill(HIST("epReso/hEpResoFT0cFV0m"), centrality, cos(harmonic * getDeltaPsiInRange(epFT0c, epFV0a)));
      registry.fill(HIST("epReso/hEpResoFT0cTPCpos"), centrality, cos(harmonic * getDeltaPsiInRange(epFT0c, epBPoss)));
      registry.fill(HIST("epReso/hEpResoFT0cTPCneg"), centrality, cos(harmonic * getDeltaPsiInRange(epFT0c, epBNegs)));
      registry.fill(HIST("epReso/hEpResoFT0aFT0m"), centrality, cos(harmonic * getDeltaPsiInRange(epFT0a, epFT0m)));
      registry.fill(HIST("epReso/hEpResoFT0aFV0m"), centrality, cos(harmonic * getDeltaPsiInRange(epFT0a, epFV0a)));
      registry.fill(HIST("epReso/hEpResoFT0aTPCpos"), centrality, cos(harmonic * getDeltaPsiInRange(epFT0a, epBPoss)));
      registry.fill(HIST("epReso/hEpResoFT0aTPCneg"), centrality, cos(harmonic * getDeltaPsiInRange(epFT0a, epBNegs)));
      registry.fill(HIST("epReso/hEpResoFT0mFV0m"), centrality, cos(harmonic * getDeltaPsiInRange(epFT0m, epFV0a)));
      registry.fill(HIST("epReso/hEpResoFT0mTPCpos"), centrality, cos(harmonic * getDeltaPsiInRange(epFT0m, epBPoss)));
      registry.fill(HIST("epReso/hEpResoFT0mTPCneg"), centrality, cos(harmonic * getDeltaPsiInRange(epFT0m, epBNegs)));
      registry.fill(HIST("epReso/hEpResoFV0mTPCpos"), centrality, cos(harmonic * getDeltaPsiInRange(epFV0a, epBPoss)));
      registry.fill(HIST("epReso/hEpResoFV0mTPCneg"), centrality, cos(harmonic * getDeltaPsiInRange(epFV0a, epBNegs)));
    }
  }
